...
namespace UnitTests
{
    public class CustomersControllerTests
    {
        ...
        public async Task CreateCustomerAsync_ReturnsOkResult_WhenCustomerIsCreated()
        {
            ...
            _mockCustomerService.Setup(service => service.BusinessAddAsync(It.IsAny<Customer>())).ReturnsAsync(result);
        ...
        public async Task UpdateCustomerAsync_ReturnsOkResult_WhenCustomerIsUpdated()
        {
            ...
            _mockCustomerService.Setup(service => service.BusinessUpdateWithDtoAsync(It.IsAny<UpdateCustomerDto>())).ReturnsAsync(result);
